...
prerequisite for the gateway-attestation work in `docs/attestation-scope.md`,
...
`docs/tee-deployment.md` runs 244 lines. That reads as a supported deployment
...
an enclave cannot own a local SQLite file. See `docs/attestation-scope.md`.
