...
The existing `docs/empirical-comparison.md` keeps the A1-A16 invariant matrix vs other vendors; this doc tracks the S12 binding-bypass / proof-integrity / protocol-abuse / replay / cross-tenant / egress+privacy scenarios.
