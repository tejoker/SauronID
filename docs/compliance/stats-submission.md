...
`sdk/typescript/src/stats/metric-catalog.ts` for Sprint 8's DP publisher.
...
- **NOT** the DP-published view — that lives in Sprint 8
  (`archive/removed-2026-08/cohort-stats-compliance/dp/`, archived) and Sprint 9 (`dashboard/`).
...
docs/compliance/stats-submission.md     — this file
```
