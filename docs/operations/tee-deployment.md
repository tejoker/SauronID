...
companion to the code at `archive/removed-2026-08/hardware-attestation/cbor.rs` and the wiring in
`archive/removed-2026-08/hardware-attestation/nitro.rs` (`verify_nitro_enclave`).
...
- [ ] Test end-to-end against a live Nitro EC2 instance running your
      ...
      **This is the step that is NOT covered by the unit tests in this
      build** — `archive/removed-2026-08/hardware-attestation/nitro_attestation.rs` uses self-signed test
...
- **Live AWS Nitro attestation production.** The unit tests in
  `archive/removed-2026-08/hardware-attestation/nitro_attestation.rs` synthesise a CBOR + COSE_Sign1 blob,
