...
# export SAURON_ACCEPT_DPOP=1                              # opt-in: accept RFC 9449 `DPoP:` proofs instead of x-sauron-call-sig (no body/config binding — see docs/integration/sdk-integration.md)
...
# Sprint 11 multi-tenancy (see docs/architecture/multi-tenancy.md). SauronID is
