...
- `archive/removed-2026-08/groth16-zkp/zk_verifier.rs` — server-side Rust verifier (process-spawn
...
The Rust implementation in `archive/removed-2026-08/groth16-zkp/zk_verifier.rs` spawns `snarkjs verify`
...
3. **Prove** — invokes `archive/removed-2026-08/groth16-zkp/zk_e2e_helper.js` (a small Node helper)
