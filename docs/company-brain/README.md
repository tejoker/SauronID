...
| Fichier | Question | Framework appliqué | État |
|---|---|---|---|
| `20-business-model.md` | comment la valeur se capture | Business Model Canvas (Osterwalder et Pigneur) et Design a Business Model, étape 15 des 24 Steps (MIT) | à écrire |
