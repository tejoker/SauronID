...
key under `security/reviewers/`, record the report SHA-256 and factual outcome
in `external-assessment.json`, and have the reviewer sign the canonical compact
