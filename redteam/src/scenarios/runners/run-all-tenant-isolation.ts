 ...
 *   node dist/scenarios/runners/run-all-tenant-isolation.js --help
 *
 * Env:
...
const SCENARIOS = [
    ...
    "tenant/tenant-policy-cross-evaluate",
    "tenant/tenant-binding-injection",
    "tenant/tenant-audit-report-leak",
    "tenant/tenant-spend-history-leak",
    "tenant/tenant-tpm2-attestation-cross",
    "tenant/tenant-anchor-merkle-extraction",
    "tenant/tenant-jwt-claim-forgery",
    "tenant/tenant-header-spoof",
    "tenant/tenant-policy-store-enumeration",
    "tenant/tenant-spend-ledger-race",
];
...
function printHelp(): void {
    const lines = [
        ...
        "",
        "Usage:",
        "  node dist/scenarios/runners/run-all-tenant-isolation.js          (run all)",
        "  node dist/scenarios/runners/run-all-tenant-isolation.js --help   (this text)",
        "",
        "Env vars:",
